...
const addTodolist = createAsyncThunk<{todolist: TodolistType}, string, ThunkError>('todolist/addTodoLists', async (title, thunkAPI: any) => {
  ...
  try {
    ...
    handleAsyncServerNetworkError(err, thunkAPI, false)
  }
})
